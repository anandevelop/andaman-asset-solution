        ...
        <div className="grid gap-12 lg:grid-cols-[1fr_380px] lg:gap-16">
          ...
          <Reveal delay={0.15}>
            <div className="lg:sticky lg:top-28 lg:self-start">
              ...
              <div className="mt-8 rounded-sm border border-[#128C7E]/25 bg-[#128C7E]/[0.06] p-5">
                <p className="flex items-center gap-2 text-sm font-medium text-primary">
                  {/* WhatsApp icon */}
                  <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16" className="text-[#128C7E]" aria-hidden>
                ...
                <a
                  ...
                  className="btn-primary mt-4 w-full !bg-[#128C7E] !text-white hover:!bg-[#0e7063]"
                >
                  {tChat("whatsappLabel")}
                </a>
              </div>
