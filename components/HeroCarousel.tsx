  ...
  return (
    ...
    >
      ...
      {/* ── Mobile content: headline and buttons grouped together, just
          ...
          bare video between them that read as disconnected. ────────────── */}
 ...
 * Button 1 ("Buy now") is the slide's own CTA, solid white against the
 * always-dark hero background; button 2 ("Learn more") is the fixed
 * secondaryCta, translucent so it reads as secondary without disappearing
  ...
  return (
    <>
      {slide.ctaLabel && slide.ctaUrl && (
        <Link
          href={slide.ctaUrl}
          className="btn-primary !border-none !bg-white !text-primary hover:!bg-white/90"
        >
          {slide.ctaLabel}
      ...
      <Link
        ...
        className="btn-outline !border-white/30 !bg-black/20 !text-white backdrop-blur-sm hover:!border-white/50 hover:!bg-black/40"
      >
        {secondaryCta.label}
      </Link>
    </>
